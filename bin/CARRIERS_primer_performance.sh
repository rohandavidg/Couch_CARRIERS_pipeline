...
#	sleep .5
	$QSUB -N primer_run_$a -V -M gnanaolivu.rohandavid@mayo.edu -wd $OUTDIR/primer_analysis/working -l h_stack=20M -l h_vmem=5G -pe threaded 2 -e $LOGS_DIR -o $PRIMER_DIR -b y $PYTHON $CARRIERS_PRIMER_CODE -p $MAYO_EXCEL -b $CARRIERS_TARGET_BED -l $bam -s $SAMPLE_INFO
